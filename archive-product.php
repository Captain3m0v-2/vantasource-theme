 ...
 *
 * Overrides WooCommerce archive-product.php with a custom layout.
 *
...
$product_count = isset($wp_query->found_posts) ? (int) $wp_query->found_posts : 0;
$shop_page_id  = wc_get_page_id('shop');
$shop_title    = $shop_page_id > 0 ? get_the_title($shop_page_id) : __('Shop', 'woocommerce');
?>
