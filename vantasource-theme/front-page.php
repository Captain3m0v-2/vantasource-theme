        ...
        <div class="row">
            <div class="col-lg-8" data-aos="fade-up">
                ...
                <div class="d-flex gap-3 flex-wrap">
                    ...
                    <a href="<?php echo home_url('/services'); ?>" class="btn btn-outline-light rounded-pill">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4" data-aos="fade-up">
                <div class="feature-card h-100">
                    ...
                    <h4 class="fw-bold mb-3">Global Logistics</h4>
            ...
            <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
                <div class="feature-card h-100">
                    ...
                    <h4 class="fw-bold mb-3">Product Sourcing</h4>
                    <p class="text-muted">Finding the perfect manufacturer with direct access to 500+ verified factories worldwide.</p>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="200">
                <div class="feature-card text-center h-100">
                    ...
                    <h5 class="fw-bold mb-2">Protection</h5>
            ...
            <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="300">
                <div class="feature-card text-center h-100">
                    ...
                    <p class="text-muted small">24/7 customer support and instant responses</p>
                </div>
            </div>
        </div>
    </div>
...
<section id="contact" class="py-5 bg-white">
    <div class="container py-5">
        <div class="cta-section">
            <h2 class="cta-title">Ready to Find Your Perfect Manufacturer?</h2>
            <p class="cta-subtitle">Get your free quote in 24 hours with detailed supplier options</p>
            <a href="<?php echo home_url('/quote'); ?>" class="btn btn-light btn-lg px-5">
                <i class="bi bi-file-earmark-text me-2"></i>Request a Quote Now
            </a>
        </div>
    </div>
</section>
